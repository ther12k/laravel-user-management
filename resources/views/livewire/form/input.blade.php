<div class="md:flex md:items-center mb-6">
    ...
    <div class="md:w-2/3 flex"  x-data="{ tooltip: false }">
        ...
        @endif  
        @isset($tooltip)
        <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-ful sm:mx-0 sm:h-10 sm:w-10" x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false" >
