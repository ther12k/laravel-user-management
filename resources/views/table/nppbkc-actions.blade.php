<div class="flex space-x-1 justify-around align-middle">
    <a href="{{route('nppbkc.view',[$id])}}#content" target="_blank" class="p-1 px-2 text-indigo-600 hover:bg-indigo-400 hover:text-white rounded">
